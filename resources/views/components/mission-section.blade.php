...
<div class="section-cont service__container">
  <div class="service-grid">
    <div class="service-card">
      ...
      <img src="images/mission-icon.png" alt="mission-logo" class="mission" loading="lazy">
      <p class="para-m">
...
insightful data-driven decisions that inspire growth and success."
    ...
    <div class="service-card">
      ...
      <img src="images/vision-icon.jpg" alt="vision-logo" class="vision" loading="lazy">
      <p class="para-m">
...
solutions that elevate brands and turn visions into reality."
    ...
    <div class="service-card">
      ...
      <img src="images/team-icon.jpg" alt="team-logo" class="team" loading="lazy">
      <p class="para-m">
